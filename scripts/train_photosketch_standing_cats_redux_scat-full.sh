#!/bin/bash
python train.py \
--name standing_cats_augment30-75000-full \
--dataroot_sketch /scratch/arturao/GANSketching22/data/sketch/photosketch/scat \
--dataroot_image /scratch/arturao/GANSketching_old/data/image/cat_new --l_image 0.7 \
--eval_dir /scratch/arturao/GANSketching_old/data/eval/standing_cat \
